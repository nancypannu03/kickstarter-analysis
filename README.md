...
- Another Challenge I encountered was with the Pivot Chart, to determine what Columns need to be dragged to the Rows, Columns and Values specified spacing inorder to make data more representable and easy for the visualization. <br />
...
- What are some other possible tables and/or graphs that we could create? <br />
  ...
  -We can create Boxplots and Whisker Plots and identify outliers for easier and effective decision making.
